...
export default function Navbar() {
  ...
  // You'll replace this with actual auth state later
            ...
            {isAuthenticated ? (
              <>
                ...
                <div className="flex items-center space-x-4">
                  <span className="text-slate-400 text-sm">Welcome, {userName}</span>
                  <Button 
                    variant="ghost" 
                    size="sm"
              ...
              {isAuthenticated ? (
                <>
                  ...
                  <div className="px-3 py-2">
                    <p className="text-slate-400 text-sm mb-2">Welcome, {userName}</p>
                    <Button 
                      variant="ghost" 
                      size="sm"
